    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!foundTreasure && lives > 0)
            {
                ...
                Console.Clear();
                //menu
                Console.WriteLine("Treasure Hunt V.1.3");
            ...
            //!foundTreasure prints where the treasure coordinate was
            ...
            {
                Console.WriteLine($"You lost! The treasure was at row {treasureRow + 1}, col {treasureCol + 1}. Better luck next time!");
